...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Tue Jun 13 12:53:04 CEST 2023 by AGP (7.4.2)</nav>
    </div>
  </header>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/expo/modules/constants/ConstantsService.kt">../../src/main/java/expo/modules/constants/ConstantsService.kt</a>:26</span>: <span class="message">Using internal inset dimension resource <code>status_bar_height</code> is not supported</span><br /><pre class="errorlines">
<span class="lineno">  23 </span>private const <span class="keyword">val</span> CONFIG_FILE_NAME = <span class="string">"app.config"</span>
<span class="lineno">  24 </span>
<span class="lineno">  25 </span>open <span class="keyword">class</span> ConstantsService(private <span class="keyword">val</span> context: Context) : InternalModule, ConstantsInterface {
<span class="caretline"><span class="lineno">  26 </span>  <span class="keyword">var</span> statusBarHeightInternal = <span class="warning">context.resources.getIdentifier(<span class="string">"status_bar_height"</span>, <span class="string">"dimen"</span>, <span class="string">"android"</span>)</span></span>
<span class="lineno">  27 </span>    .takeIf { it > <span class="number">0</span> }
<span class="lineno">  28 </span>    ?.let { (context.resources::getDimensionPixelSize)(it) }
<span class="lineno">  29 </span>    ?.let { pixels -> convertPixelsToDp(pixels.toFloat(), context) }
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/expo/modules/constants/ConstantsService.kt">../../src/main/java/expo/modules/constants/ConstantsService.kt</a>:26</span>: <span class="message">Use of this function is discouraged because resource reflection makes it harder to perform build optimizations and compile-time verification of code. It is much more efficient to retrieve resources by identifier (e.g. <code>R.foo.bar</code>) than by name (e.g. <code>getIdentifier("bar", "foo", null)</code>).</span><br /><pre class="errorlines">
<span class="lineno">  23 </span>private const <span class="keyword">val</span> CONFIG_FILE_NAME = <span class="string">"app.config"</span>
<span class="lineno">  24 </span>
<span class="lineno">  25 </span>open <span class="keyword">class</span> ConstantsService(private <span class="keyword">val</span> context: Context) : InternalModule, ConstantsInterface {
<span class="caretline"><span class="lineno">  26 </span>  <span class="keyword">var</span> statusBarHeightInternal = context.resources.<span class="warning">getIdentifier</span>(<span class="string">"status_bar_height"</span>, <span class="string">"dimen"</span>, <span class="string">"android"</span>)</span>
<span class="lineno">  27 </span>    .takeIf { it > <span class="number">0</span> }
<span class="lineno">  28 </span>    ?.let { (context.resources::getDimensionPixelSize)(it) }
<span class="lineno">  29 </span>    ?.let { pixels -> convertPixelsToDp(pixels.toFloat(), context) }
</pre>
