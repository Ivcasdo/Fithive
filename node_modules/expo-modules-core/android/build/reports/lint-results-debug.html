...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 6 errors and 3 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Tue Jun 13 12:53:41 CEST 2023 by AGP (7.4.2)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#NewApi"><i class="material-icons error-icon">error</i>Calling new methods on older versions (6)</a>
      <a class="mdl-navigation__link" href="#HardwareIds"><i class="material-icons warning-icon">warning</i>Hardware Id Usage (1)</a>
    </nav>
  </div>
...
<tr><td></td><td class="categoryColumn"><a href="#ExtraIssues">Included Additional Checks (17)</a>
</td></tr>
...
<span class="location"><a href="file:///C:/Users/ivan/.gradle/caches/transforms-3/95aa226eacca12cc12323d65fdade91f/transformed/fragment-1.4.1/jars/lint.jar">C:\Users\ivan\.gradle\caches\transforms-3\95aa226eacca12cc12323d65fdade91f\transformed\fragment-1.4.1\jars\lint.jar</a></span>: <span class="message">Library lint checks out of date;<br/>
these checks <b>will be skipped</b>!<br/>
<br/>
Lint found an issue registry (<code>androidx.fragment.lint.FragmentIssueRegistry</code>)<br/>
which was compiled against an older version of lint<br/>
than this one. This is usually fine, but not in this<br/>
case; some basic verification shows that the lint<br/>
check jar references (for example) the following API<br/>
which is no longer valid in this version of lint:<br/>
org.jetbrains.uast.kotlin.KotlinUClass: org.jetbrains.kotlin.psi.KtClassOrObject getKtClass()<br/>
(Referenced from androidx/fragment/lint/OnCreateDialogIncorrectCallbackDetector$UastHandler.class)<br/>
<br/>
Therefore, this lint check library is <b>not</b> included<br/>
in analysis. This affects the following lint checks:<br/>
<code>FragmentTagUsage</code><br/>
<code>FragmentAddMenuProvider</code><br/>
<code>FragmentBackPressedCallback</code><br/>
<code>FragmentLiveDataObserve</code><br/>
<code>UseRequireInsteadOfGet</code><br/>
<code>UseGetLayoutInflater</code><br/>
<code>DialogFragmentCallbacksDetector</code><br/>
<code>UnsafeRepeatOnLifecycleDetector</code><br/>
<code>DetachAndAttachSameFragment</code><br/>
<br/>
Recompile the checks against the latest version, or if<br/>
this is a check bundled with a third-party library, see<br/>
if there is a more recent version available.<br/>
<br/>
Version of Lint API this lint check is using is 11.<br/>
The Lint API version currently running is 13 (7.3+).</span><br />
</div>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/expo/modules/adapters/react/permissions/PermissionsService.kt">../../src/main/java/expo/modules/adapters/react/permissions/PermissionsService.kt</a>:327</span>: <span class="message">This method should be annotated with <code>@ChecksSdkIntAtLeast(api=Build.VERSION_CODES.M)</code></span><br /><pre class="errorlines">
<span class="lineno"> 324 </span>    }
<span class="lineno"> 325 </span>  }
<span class="lineno"> 326 </span>
<span class="caretline"><span class="lineno"> 327 </span>  private <span class="keyword">fun</span> <span class="warning">isRuntimePermissionsAvailable</span>() = Build.VERSION.SDK_INT >= Build.VERSION_CODES.M&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 328 </span>
<span class="lineno"> 329 </span>  override <span class="keyword">fun</span> onHostResume() {
<span class="lineno"> 330 </span>    <span class="keyword">if</span> (!mWriteSettingsPermissionBeingAsked) {
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/expo/modules/kotlin/types/ColorTypeConverter.kt">../../src/main/java/expo/modules/kotlin/types/ColorTypeConverter.kt</a>:201</span>: <span class="message">Call requires API level 26 (current min is 21): <code>android.graphics.Color#valueOf</code></span><br /><pre class="errorlines">
<span class="lineno"> 198 </span>
<span class="lineno"> 199 </span>  private <span class="keyword">fun</span> colorFromDoubleArray(value: DoubleArray): Color {
<span class="lineno"> 200 </span>    <span class="keyword">val</span> alpha = value.getOrNull(<span class="number">3</span>) ?: <span class="number">1.0</span>
<span class="caretline"><span class="lineno"> 201 </span>    <span class="keyword">return</span> Color.<span class="error">valueOf</span>(value[<span class="number">0</span>].toFloat(), value[<span class="number">1</span>].toFloat(), value[<span class="number">2</span>].toFloat(), alpha.toFloat())</span>
<span class="lineno"> 202 </span>  }
<span class="lineno"> 203 </span>
<span class="lineno"> 204 </span>  private <span class="keyword">fun</span> colorFromInt(value: Int): Color {
</pre>

<span class="location"><a href="../../src/main/java/expo/modules/kotlin/types/ColorTypeConverter.kt">../../src/main/java/expo/modules/kotlin/types/ColorTypeConverter.kt</a>:205</span>: <span class="message">Call requires API level 26 (current min is 21): <code>android.graphics.Color#valueOf</code></span><br /><pre class="errorlines">
<span class="lineno"> 202 </span>  }
<span class="lineno"> 203 </span>
<span class="lineno"> 204 </span>  private <span class="keyword">fun</span> colorFromInt(value: Int): Color {
<span class="caretline"><span class="lineno"> 205 </span>    <span class="keyword">return</span> Color.<span class="error">valueOf</span>(value)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 206 </span>  }
<span class="lineno"> 207 </span>
<span class="lineno"> 208 </span>  private <span class="keyword">fun</span> colorFromString(value: String): Color {
</pre>

<span class="location"><a href="../../src/main/java/expo/modules/kotlin/types/ColorTypeConverter.kt">../../src/main/java/expo/modules/kotlin/types/ColorTypeConverter.kt</a>:211</span>: <span class="message">Call requires API level 26 (current min is 21): <code>android.graphics.Color#valueOf</code></span><br /><pre class="errorlines">
<span class="lineno"> 208 </span>  private <span class="keyword">fun</span> colorFromString(value: String): Color {
<span class="lineno"> 209 </span>    <span class="keyword">val</span> colorFromString = namedColors[value]
<span class="lineno"> 210 </span>    <span class="keyword">if</span> (colorFromString != <span class="keyword">null</span>) {
<span class="caretline"><span class="lineno"> 211 </span>      <span class="keyword">return</span> Color.<span class="error">valueOf</span>(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 212 </span>        colorFromString[<span class="number">0</span>],
<span class="lineno"> 213 </span>        colorFromString[<span class="number">1</span>],
<span class="lineno"> 214 </span>        colorFromString[<span class="number">2</span>],
</pre>

<span class="location"><a href="../../src/main/java/expo/modules/kotlin/types/ColorTypeConverter.kt">../../src/main/java/expo/modules/kotlin/types/ColorTypeConverter.kt</a>:219</span>: <span class="message">Call requires API level 26 (current min is 21): <code>android.graphics.Color#valueOf</code></span><br /><pre class="errorlines">
<span class="lineno"> 216 </span>      )
<span class="lineno"> 217 </span>    }
<span class="lineno"> 218 </span>
<span class="caretline"><span class="lineno"> 219 </span>    <span class="keyword">return</span> Color.<span class="error">valueOf</span>(Color.parseColor(value))&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 220 </span>  }
<span class="lineno"> 221 </span>
<span class="lineno"> 222 </span>  override <span class="keyword">fun</span> getCppRequiredTypes(): ExpectedType =
</pre>

<span class="location"><a href="../../src/main/java/expo/modules/kotlin/types/io/PathTypeConverter.kt">../../src/main/java/expo/modules/kotlin/types/io/PathTypeConverter.kt</a>:13</span>: <span class="message">Call requires API level 26 (current min is 21): <code>java.nio.file.Paths#get</code></span><br /><pre class="errorlines">
<span class="lineno"> 10 </span><span class="keyword">class</span> PathTypeConverter(isOptional: Boolean) : DynamicAwareTypeConverters&lt;Path>(isOptional) {
<span class="lineno"> 11 </span>  override <span class="keyword">fun</span> convertFromDynamic(value: Dynamic): Path {
<span class="lineno"> 12 </span>    <span class="keyword">val</span> stringPath = value.asString()
<span class="caretline"><span class="lineno"> 13 </span>    <span class="keyword">return</span> Paths.<span class="error">get</span>(stringPath)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 14 </span>  }
<span class="lineno"> 15 </span>
<span class="lineno"> 16 </span>  override <span class="keyword">fun</span> convertFromAny(value: Any): Path {
</pre>

<span class="location"><a href="../../src/main/java/expo/modules/kotlin/types/io/PathTypeConverter.kt">../../src/main/java/expo/modules/kotlin/types/io/PathTypeConverter.kt</a>:18</span>: <span class="message">Call requires API level 26 (current min is 21): <code>java.nio.file.Paths#get</code></span><br /><pre class="errorlines">
<span class="lineno"> 15 </span>
<span class="lineno"> 16 </span>  override <span class="keyword">fun</span> convertFromAny(value: Any): Path {
<span class="lineno"> 17 </span>    <span class="keyword">val</span> stringPath = value <span class="keyword">as</span> String
<span class="caretline"><span class="lineno"> 18 </span>    <span class="keyword">return</span> Paths.<span class="error">get</span>(stringPath)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 19 </span>  }
<span class="lineno"> 20 </span>
<span class="lineno"> 21 </span>  override <span class="keyword">fun</span> getCppRequiredTypes(): ExpectedType = ExpectedType(CppType.STRING)
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/expo/modules/core/utilities/EmulatorUtilities.kt">../../src/main/java/expo/modules/core/utilities/EmulatorUtilities.kt</a>:30</span>: <span class="message">Using <code>SERIAL</code> to get device identifiers is not recommended</span><br /><pre class="errorlines">
<span class="lineno"> 27 </span>      Build.BOOTLOADER.lowercase(Locale.ROOT).contains(<span class="string">"nox"</span>) ||
<span class="lineno"> 28 </span>      Build.HARDWARE.lowercase(Locale.ROOT).contains(<span class="string">"nox"</span>) ||
<span class="lineno"> 29 </span>      Build.PRODUCT.lowercase(Locale.ROOT).contains(<span class="string">"nox"</span>) ||
<span class="caretline"><span class="lineno"> 30 </span>      Build.<span class="warning">SERIAL</span>.lowercase(Locale.ROOT).contains(<span class="string">"nox"</span>) ||&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 31 </span>      (Build.BRAND.startsWith(<span class="string">"generic"</span>) &amp;&amp; Build.DEVICE.startsWith(<span class="string">"generic"</span>))
...
Vendor: Android Open Source Project (jetified-activity-1.4.0)<br/>
Identifier: jetified-activity-1.4.0<br/>
Feedback: <a href="https://issuetracker.google.com/issues/new?component=192731">https://issuetracker.google.com/issues/new?component=192731</a><br/>
</div>
<br/>
<br/></div>
...
Vendor: Android Open Source Project (jetified-lifecycle-livedata-core-ktx-2.3.1)<br/>
Identifier: jetified-lifecycle-livedata-core-ktx-2.3.1<br/>
Feedback: <a href="https://issuetracker.google.com/issues/new?component=192731">https://issuetracker.google.com/issues/new?component=192731</a><br/>
</div>
<br/>
<br/></div>
...
Vendor: Android Open Source Project (jetified-lifecycle-runtime-ktx-2.3.1)<br/>
Identifier: jetified-lifecycle-runtime-ktx-2.3.1<br/>
Feedback: <a href="https://issuetracker.google.com/issues/new?component=192731">https://issuetracker.google.com/issues/new?component=192731</a><br/>
</div>
<br/>
<br/></div>
