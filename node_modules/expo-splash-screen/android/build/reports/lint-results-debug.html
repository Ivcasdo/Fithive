...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 5 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Tue Jun 13 12:53:31 CEST 2023 by AGP (7.4.2)</nav>
    </div>
  </header>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/SplashScreenReactActivityLifecycleListener.kt">../../src/main/java/expo/modules/splashscreen/SplashScreenReactActivityLifecycleListener.kt</a>:35</span>: <span class="message">Implicitly using the default locale is a common source of bugs: Use <code>toLowerCase(Locale)</code> instead. For strings meant to be internal use <code>Locale.ROOT</code>, otherwise <code>Locale.getDefault()</code>.</span><br /><pre class="errorlines">
<span class="lineno"> 32 </span>
<span class="lineno"> 33 </span>  private <span class="keyword">fun</span> getResizeMode(context: Context): SplashScreenImageResizeMode =
<span class="lineno"> 34 </span>    SplashScreenImageResizeMode.fromString(
<span class="caretline"><span class="lineno"> 35 </span>      context.getString(R.string.expo_splash_screen_resize_mode).<span class="warning">toLowerCase</span>()&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 36 </span>    )
<span class="lineno"> 37 </span>      ?: SplashScreenImageResizeMode.CONTAIN
</pre>
...
Dismiss</button>            </div>
          ...
          </section><a name="CustomSplashScreen"></a>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/SplashScreenView.kt">../../src/main/java/expo/modules/splashscreen/SplashScreenView.kt</a>:15</span>: <span class="message">The application should not provide its own launch screen</span><br /><pre class="errorlines">
<span class="lineno"> 12 </span><span class="comment">/* ktlint-enable no-unused-imports */</span>
<span class="lineno"> 13 </span>
<span class="lineno"> 14 </span><span class="annotation">@SuppressLint</span>(<span class="string">"ViewConstructor"</span>)
<span class="caretline"><span class="lineno"> 15 </span><span class="keyword">class</span> <span class="warning">SplashScreenView</span>(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 16 </span>  context: Context
<span class="lineno"> 17 </span>) : RelativeLayout(context) {
<span class="lineno"> 18 </span>  <span class="keyword">val</span> imageView: ImageView = ImageView(context).also { view ->
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/res/values/styles_splashscreen.xml">../../src/main/res/values/styles_splashscreen.xml</a>:5</span>: <span class="message">The resource <code>R.style.Theme_App_SplashScreen</code> appears to be unused</span><br /><pre class="errorlines">
<span class="lineno">  2 </span><span class="comment">    Settings in this file should/will be overridden by specific app's resources.
</span><span class="lineno">  3 </span><span class="comment">--></span>
<span class="lineno">  4 </span><span class="tag">&lt;resources></span>
<span class="caretline"><span class="lineno">  5 </span>  <span class="tag">&lt;style</span><span class="attribute"> </span><span class="warning"><span class="attribute">name</span>=<span class="value">"Theme.App.SplashScreen"</span></span> <span class="attribute">parent</span>=<span class="value">"Theme.AppCompat.Light.NoActionBar"</span>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  6 </span>    <span class="tag">&lt;item</span><span class="attribute"> name</span>=<span class="value">"android:windowBackground"</span>>@drawable/splashscreen<span class="tag">&lt;/item></span>
<span class="lineno">  7 </span>    <span class="tag">&lt;item</span><span class="attribute"> name</span>=<span class="value">"android:windowDrawsSystemBarBackgrounds"</span>>true<span class="tag">&lt;/item></span>
<span class="lineno">  8 </span>    <span class="tag">&lt;item</span><span class="attribute"> name</span>=<span class="value">"android:statusBarColor"</span>>@android:color/transparent<span class="tag">&lt;/item></span></pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/res/drawable/splashscreen_image.png">../../src/main/res/drawable/splashscreen_image.png</a></span>: <img class="embedimage" align="right" src="../../src/main/res/drawable/splashscreen_image.png" /><span class="message">Found bitmap drawable <code>res/drawable/splashscreen_image.png</code> in densityless folder</span><br clear="right"/>
</div>
