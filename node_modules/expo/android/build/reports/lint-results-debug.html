...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Tue Jun 13 12:52:44 CEST 2023 by AGP (7.4.2)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#VisibleForTests"><i class="material-icons warning-icon">warning</i>Visible Only For Tests (2)</a>
    </nav>
  </div>
...
<a name="DiscouragedPrivateApi"></a>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/expo/modules/ReactActivityDelegateWrapper.kt">../../src/main/java/expo/modules/ReactActivityDelegateWrapper.kt</a>:93</span>: <span class="message">Reflective access to accessFlags, which is not part of the public SDK and therefore likely to change in future Android releases</span><br /><pre class="errorlines">
<span class="lineno">  90 </span>    <span class="keyword">if</span> (newDelegate != <span class="keyword">null</span> &amp;&amp; newDelegate != <span class="keyword">this</span>) {
<span class="lineno">  91 </span>      <span class="keyword">val</span> mDelegateField = ReactActivity::<span class="keyword">class</span>.java.getDeclaredField(<span class="string">"mDelegate"</span>)
<span class="lineno">  92 </span>      mDelegateField.isAccessible = <span class="keyword">true</span>
<span class="caretline"><span class="lineno">  93 </span>      <span class="keyword">val</span> modifiers = <span class="warning">Field::<span class="keyword">class</span>.java.getDeclaredField(<span class="string">"accessFlags"</span>)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  94 </span>      modifiers.isAccessible = <span class="keyword">true</span>
<span class="lineno">  95 </span>      modifiers.setInt(mDelegateField, mDelegateField.modifiers and Modifier.FINAL.inv())
<span class="lineno">  96 </span>      mDelegateField.set(activity, newDelegate)
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/expo/modules/ReactActivityDelegateWrapper.kt">../../src/main/java/expo/modules/ReactActivityDelegateWrapper.kt</a>:160</span>: <span class="message">This method should only be accessed from tests or within private scope</span><br /><pre class="errorlines">
<span class="lineno"> 157 </span><span class="javadoc">     *
</span><span class="lineno"> 158 </span><span class="javadoc">     * TODO (@bbarthec): fix it upstream?
</span><span class="lineno"> 159 </span><span class="javadoc">     */</span>
<span class="caretline"><span class="lineno"> 160 </span>    <span class="keyword">if</span> (delegate.reactInstanceManager.<span class="warning">currentReactContext</span> == <span class="keyword">null</span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 161 </span>      <span class="keyword">val</span> reactContextListener = <span class="keyword">object</span> : ReactInstanceEventListener {
<span class="lineno"> 162 </span>        override <span class="keyword">fun</span> onReactContextInitialized(context: ReactContext?) {
<span class="lineno"> 163 </span>          delegate.reactInstanceManager.removeReactInstanceEventListener(<span class="keyword">this</span>)
</pre>
